...
<head>
    ...
    <script type="text/javascript">
        ...
        function uiCallTerminated(s_description) {
            document.getElementById("incomingPanel").style.opocity=0;
            uiBtnCallSetText("Call");
...
{{-- Call Notification Tab --}}
    {{-- <div style="position:fixed;bottom:20px;right:20px;z-index:9999;" id="incomingPanel">
        <div style="max-width:200;border-radius:10px;padding:20px;border:1px solid black;">
            <p>Incoming...............</p>
            <button class="btn btn-success" id="btnCall">Answer</button>
            <button class="btn btn-danger" id="btnHangUp" onclick='sipHangUp();' disabled>Reject</button>
        </div>
    </div> --}}
    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div id="divCallCtrl" class="span7 well" style='max-width:300px; display:table-cell; vertical-align:middle;position:fixed;bottom:20px;right:20px'>
            <div class="border-radius:10px;padding:20px;border:1px solid black;">           
    ...
    <audio id="ringtone" loop src="{{ asset('sounds/ringtone1.mp3') }}"> </audio>
